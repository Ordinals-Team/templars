    ...
    <div className="relative w-full">
      ...
      {alertOpen && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/80 p-6">
          <div className="bg-[#F9E9C5] text-[#100A0A] p-8 rounded-xl shadow-xl max-w-sm w-full text-center">
            <h2 className="font-bold text-3xl mb-4">Coming Soon</h2>
            <button
              onClick={() => setAlertOpen(false)}
              className="mt-4 px-8 py-3 bg-[#100A0A] text-[#F9E9C5] rounded-md hover:opacity-90 transition"
            >
              Close
            </button>
          </div>
